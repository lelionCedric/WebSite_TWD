...
echo "</br></br><a style=\"postion=hinerit; text-align:center;\" href=\"http://hina/~celelion/SiteWeb/?action=put&id="."&titreArticle=".$titreArticle."&description=".$description."&dateMiseEnLigne=".$dateMiseEnLigne."\"".">Valider l'article</a>";
}
else
{
    $article = ArticleFabrique::getArticle($datatest, null, $titreArticle, $description, $dateMiseEnLigne);
    echo ArticleFormView::getFormErrorsHtml("receptionArticle.php?action=put", $article, $dataErrors);
