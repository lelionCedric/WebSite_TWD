...
class DataBaseManager{
	...
	static private $db_name="dbname=dbcelelion";
	
	static private $db_user="celelion";
	static private $db_password="ce270695";
	...
	private function __construct()
	 {
		try{
			...
			echo "<p> Erreur de connexion à la base de données<br/>"."pas besoin d'en savoir plus"."</p>";	
			die();
		}
	 }
